...
export default function Skill() {
    ...
    return (
        ...
        <div className="md:h-[790px] h-[850px] bg-slate-100 dark:bg-slate-900">
            <div className="font-poopins text-center pt-11 text-black">
                <p className="md:text-[36px] text-[20px] dark:text-white">My Skills</p>
            ...
            <div className="md:max-w-[1200px] md:m-auto pt-9 md:pt-9 font-poopins grid md:grid-cols-3 sm:grid-cols-2 md:gap-9 grid-cols-2 md:gap-y-9 gap-5 px-6">
                <div className="bg-white h-[210px] rounded-xl dark:bg-slate-700 dark:text-white shadow-md md:max-w-[400px] md:h-[250px] md:rounded-2xl md:shadow-2xl hover:shadow-2xl p-2">
                ...
                <div className="bg-white h-[210px] md:max-w-[400px] dark:bg-slate-700 dark:text-white md:h-[250px] md:rounded-2xl rounded-xl md:shadow-2xl shadow-md p-2">
                ...
                <div className="bg-white h-[210px] md:max-w-[400px] dark:bg-slate-700 dark:text-white md:h-[250px] md:rounded-2xl rounded-xl shadow-md md:shadow-2xl p-2">
                    ...
                    <p className="text-center md:text-sm text-[9px] text-slate-500 font-light md:pt-2 md:px-11 dark:text-slate-300">"I develop robust, scalable back-end systems with Spring Boot, ensuring smooth and efficient performance for web applications."</p>
                </div>
