        ...
        <div className={`${mode && "dark"} `}>
            ...
            <div className="dark:bg-slate-900">
                <div className="pt-[140px] h-auto md:w-10/12 m-auto flex-wrap md:flex md:pb-[100px]">
                    ...
                    <div className="text-slate-700 vsm:text-[10px] font-poopins w-10/12 md:w-5/12 m-auto text-center pb-1 dark:text-slate-200">

                        <div className="font-poopins text-2xl text-slate-400 text-center pt-4 dark:text-slate-300">
                            <p>About me</p>
                        </div>
